	...
	int32_t gain)
{
	...
	std::cout << "Device open£º" << nowtime << "\n";
	...
	std::cout << "Device started£º" << nowtime << std::endl;
	...
	nowtime = duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch()).count();
	std::cout << "create file£º" << nowtime << std::endl;
	...
	k4a_capture_t capture;
	nowtime = duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch()).count();
	std::cout << "Started recording£º" << nowtime << std::endl;
